    ...
    if (request.getMethod().equals("POST")) {
        if (request.getParameter("txtNome") != null) {
            ...
            if (request.getParameter("txtFoto1") != null) {
                l.setFoto1(request.getParameter("txtFoto1"));
            }

            if (request.getParameter("txtFoto2") != null) {
                l.setFoto2(request.getParameter("txtFoto2"));
            }

            if (request.getParameter("txtFoto3") != null) {
                l.setFoto3(request.getParameter("txtFoto3"));
            }
        ...
        <div class="panel-body">
            ...
            <form action="../UploadWS" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label>Foto 1</label>
                        <input type="file"  name="txtFoto1"/>
                    </div>

                    <div class="form-group">
                        <label>Foto 2</label>
                        <input type="file"  name="txtFoto2"/>
                    </div>

                    <div class="form-group">
                        <label>Foto 3</label>
                        <input type="file"  name="txtFoto3"/>
                    </div>
